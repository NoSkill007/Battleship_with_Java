...
public class Jugador_1 extends javax.swing.JPanel {

    public static Boolean[][] Estado_Juego = new Boolean[10][10];
    static boolean Barcos_Guardados = false;
    static boolean Ejecutado = true;
    private static Jugador_1 instance;
    Cambio_Turno1 Cambio_Turno1 = new Cambio_Turno1();
    ...
    public Jugador_1() {
        initComponents();
        actualizarNombre1();
        Coordenadas_P1.setFocusable(false);
        MATRIZ1.setVisible(false);
        Matriz1_1.setVisible(false);

        if (!Barcos_Guardados) {
            Coordenadas_P1.setVisible(false);
    ...
    private void initComponents() {
        ...
        add(Mapa, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 405, 405));
        ...
        Img_Capitan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Capitan1.png"))); // NOI18N
        ...
        Coordenadas_P1.setFont(new java.awt.Font("Roboto Light", 0, 14)); // NOI18N
        Coordenadas_P1.setForeground(new java.awt.Color(153, 153, 153));
        Coordenadas_P1.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        Coordenadas_P1.setText("A,1");
        Coordenadas_P1.setBorder(javax.swing.BorderFactory.createEtchedBorder());
        Coordenadas_P1.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                Coordenadas_P1MouseClicked(evt);
            }
        });
        add(Coordenadas_P1, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 300, 60, 30));
        ...
        Usuario_1.setFont(new java.awt.Font("Roboto Black", 1, 24)); // NOI18N
        Usuario_1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        add(Usuario_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 25, 160, 45));
        ...
        Matriz1_1.setBorder(null);
        Matriz1_1.setHorizontalScrollBarPolicy(javax.swing.ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        Matriz1_1.setVerticalScrollBarPolicy(javax.swing.ScrollPaneConstants.VERTICAL_SCROLLBAR_NEVER);
        Matriz1_1.setFocusable(false);
        Matriz1_1.setFont(new java.awt.Font("Roboto Light", 1, 12)); // NOI18N
        Matriz1_1.setVerifyInputWhenFocusTarget(false);
        Matriz1_1.setWheelScrollingEnabled(false);

        MATRIZ1.setBorder(null);
        MATRIZ1.setFont(new java.awt.Font("Monospaced", 1, 9)); // NOI18N
        MATRIZ1.setAutoscrolls(false);
        MATRIZ1.setFocusable(false);
        MATRIZ1.setRequestFocusEnabled(false);
        Matriz1_1.setViewportView(MATRIZ1);

        add(Matriz1_1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 350, 120, 120));
    }// </editor-fold>//GEN-END:initComponents

    private void Coordenadas_P1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Coordenadas_P1MouseClicked
        if (Coordenadas_P1.getText().equals("A,1")) {
            Coordenadas_P1.setFocusable(true);
            Coordenadas_P1.requestFocusInWindow();
            Coordenadas_P1.setText("");
            Coordenadas_P1.setForeground(Color.black);
        }
    }//GEN-LAST:event_Coordenadas_P1MouseClicked
    ...
    public static boolean[][] Barcos_EnTablero1 = new boolean[10][10];
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (text.charAt(1) == ',') {
                    ...
                    if (x >= 1 && x <= 9 && y >= 1 && y <= 9 && Coordenadas[x][y].getText().isEmpty()) {
                        ...
                        if (Jugador_2.Barcos_EnTablero2[x][y]) {
                        ...
                        for (int i = 1; i <= 9; i++) {
                            for (int j = 1; j <= 9; j++) {
                                if (Jugador_2.Barcos_EnTablero2[i][j] && (Estado_Juego[i][j] == null || !Estado_Juego[i][j])) {
                                    allRevealed = false;
                                    break;
                                }
                            }
                        ...
                        if (allRevealed) {
                            Timer timer = new Timer(1000, new ActionListener() {
                                @Override
                                public void actionPerformed(ActionEvent e) {
                                    Mostrar_Ganador.instancia.setJugador1Gana(true);
    ...
    private javax.swing.JTextField Coordenadas_P1;
    ...
    private javax.swing.JScrollPane Matriz1_1;
